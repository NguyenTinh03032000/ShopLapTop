package com.shoplaptop.api.admin;
...
import com.shoplaptop.entities.ResponseObject;
...
import com.shoplaptop.validator.NguoiDungValidator;
...
public class TaiKhoanApi {
	...
	public Page<NguoiDung> getNguoiDungByVaiTro(@RequestParam("tenVaiTro") String tenVaiTro,
		...
		VaiTro vaiTro = vaiTroService.findByTenVaiTro(tenVaiTro);
